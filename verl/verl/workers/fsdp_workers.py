...
class ActorRolloutRefWorker(Worker):
    ...
    def __init__(self, config: DictConfig, role: str):
        ...
        if self._is_actor:
            ...
            # print(f"#################### actor after normalize actor.ppo_mini_batch_size: {self.config.actor.ppo_mini_batch_size}")
            # print(f"#################### actor after normalize actor.ppo_micro_batch_size: {self.config.actor.ppo_micro_batch_size}")
        ...
        if self._is_rollout and self.config.rollout.log_prob_micro_batch_size is not None:
            ...
            # print(f"#################### rollout after normalize rollout.log_prob_micro_batch_size: {self.config.rollout.log_prob_micro_batch_size}")
        ...
        if self._is_ref and self.config.ref.log_prob_micro_batch_size is not None:
            ...
            # print(f"#################### ref after normalize ref.log_prob_micro_batch_size: {self.config.ref.log_prob_micro_batch_size}")
...
class CriticWorker(Worker):
    ...
    def __init__(self, config):
        ...
        # print(f"#################### critic after normalize ppo_mini_batch_size: {self.config.ppo_mini_batch_size}")
        # print(f"#################### critic after normalize ppo_micro_batch_size: {self.config.ppo_micro_batch_size}")
