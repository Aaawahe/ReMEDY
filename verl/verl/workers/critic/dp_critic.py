...
class DataParallelPPOCritic(BasePPOCritic):
    ...
    def update_critic(self, data: DataProto):
        ...
        # print(f"#################### update_critic data: {len(data)}")
        # print(f"#################### update_critic mini batch size: {self.config.ppo_mini_batch_size}")
        # print(f"#################### update_critic micro batch size: {self.config.ppo_micro_batch_size_per_gpu}")
        # print(f"#################### update_critic dataloader count : {len(dataloader)}")
